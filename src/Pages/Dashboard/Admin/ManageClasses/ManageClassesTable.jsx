            ...
            <td>
                <div className="tooltip" data-tip={cls.status === 'deny' ? 'Already Deny' : 'Deny'}>
                    <button
                        ...
                        className="btn text-lg hover:bg-red-700 bg-white hover:text-white dark:disabled:bg-slate-400"
                    >
                        <HiXMark />
                    </button>{' '}
                </div>
            ...
            <td>
                <div className="tooltip" data-tip="Sent FeedBack">
                    <button
                        ...
                        className="btn text-lg hover:bg-slate-500 bg-white hover:text-white dark:disabled:bg-slate-400"
                    >
                        <VscFeedback />
                    </button>{' '}
                </div>

...
function UpdateClass() {
  ...
  const onSubmit = (event) => {
    ...
    if (image.length > 0) {
      axios
        .post(
          `https://api.cloudinary.com/v1_1/dcpdcdfxy/image/upload`,
          formData
        )
        .then((image) => {
      ...
      >
        <div className="lg:flex items-center gap-5">
          ...
          <div className="w-full">
            ...
            <input
              name="className"
              className=" outline-none shadow focus:shadow-lg dark:bg-slate-900 dark:text-white  rounded-lg px-3 h-11 w-full my-2 focus:border-s-8 bg-white text-dark-grey "
              type="text"
        ...
        <textarea
          rows="10"
          name="classDetails"
          className=" py-2 outline-none border-none shadow focus:shadow-lg dark:bg-slate-900 dark:text-white  rounded-lg px-3  w-full my-2 border bg-white text-dark-grey "
        ...
        <input
          disabled={loading}
          className="w-full h-11 btn mt-5 bg-blue-700 capitalize text-lg text-white hover:bg-dark-grey dark:hover:bg-slate-300 dark:hover:text-black disabled:text-dark-grey border-none"
          type="submit"
          value={loading ? "Waiting" : "update Class"}
        />
      </form>
    </div>
  );

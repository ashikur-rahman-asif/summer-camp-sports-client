  ...
  return (
    <div className="">
      ...
      >
        ...
        <input
          disabled={loading}
          className="w-full h-11 btn mt-5 bg-blue-700 disabled:text-dark-grey text-white hover:bg-dark-grey dark:hover:bg-slate-300 dark:hover:text-black border-none"
          type="submit"
          value={loading ? "Waiting" : "Add Class"}
        />
      </form>
    </div>
  );

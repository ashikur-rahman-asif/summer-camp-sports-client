                                ...
                                <tr>
                                    ...
                                    <td>
                                        <Link to={`/dashboard/payment/${classes._id}`}>
                                            <button className="btn btn-sm bg-white hover:bg-green  hover:text-white text-dark-grey	border-none">
                                                <MdPayment /> Pay now
                                            </button>
                                        </Link>
                                    </td>
                                    <td>
                                        <button
                                            ...
                                            className="btn btn-sm capitalize hover:bg-red-500 border-2 border-black hover:text-white border-none"
                                        >
